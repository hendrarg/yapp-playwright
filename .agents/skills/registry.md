...
| `add-test-spec` | Creating automation from a test case document or TC ID |
...
| `network-mocking` | Mocking payment, email, analytics, or other external services |
...
| `tag-compliance` | Auditing or fixing required Playwright test tags |
