...
import { addCustomBuyerQuestion, closeProductCompleteModal, copyProductCompleteLink, expectEmbedLinksSaved, expectInvalidEmbedLinkFeedback, expectMandatoryBuyerFieldsProtected, expectProductCompleteModal, fillEmbedLink, openEmbedLinkDialog, readProductCompleteSharePath, saveAsDraft, saveCurrentEmbedLink } from '@helpers/creator/product-editor';

test.describe('Creator Online Course', () => {
